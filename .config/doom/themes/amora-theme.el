;;; amora-theme.el -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup amora-theme nil
  "Options for the `amora' theme."
  :group 'doom-themes)

(defcustom amora-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'amora-theme
  :type 'boolean)

(defcustom amora-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'amora-theme
  :type 'boolean)

(defcustom amora-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to the
original Dracula Emacs theme."
  :group 'amora-theme
  :type 'boolean)

(defcustom amora-comment-bg amora-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'amora-theme
  :type 'boolean)

(defcustom amora-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme amora
  "A dark theme based on Dracula theme"

  ;; name        default   256       16
  ((bg         '("#1a1a2e" "#1a1a2e" "black"        ))
   (bg-alt     '("#161627" "#161627" "black"        ))
   (base0      '("#121221" "#121221" "black"        ))
   (base1      '("#161627" "#161627" "brightblack"  ))
   (base2      '("#1a1a2e" "#1a1a2e" "brightblack"  ))
   (base3      '("#23223d" "#23223d" "brightblack"  ))
   (base4      '("#2f2e51" "#2f2e51" "brightblack"  ))
   (base5      '("#565393" "#565393" "brightblack"  ))
   (base6      '("#b6b6b2" "#bbbbbb" "brightblack"  ))
   (base7      '("#d5cde8" "#d5cde8" "brightblack"  ))
   (base8      '("#e2d9f6" "#e2d9f6" "white"        ))
   (fg         '("#DEDBEB" "#DEDBEB" "white"        ))
   (fg-alt     '("#DEDBEB" "#DEDBEB" "brightwhite"  ))

   (grey       base4)
   (red        '("#fb5c8e" "#fb5c8e" "red"          ))
   (orange     '("#ffb86c" "#ffbb66" "brightred"    ))
   (green      '("#9fd3b3" "#9fd3b3" "green"        ))
   (teal       '("#93c5e6" "#0189cc" "brightgreen"  ))
   (yellow     '("#fff0b8" "#fff0b8" "yellow"       ))
   (blue       '("#b2aeff" "#b2aeff" "brightblue"   ))
   (dark-blue  '("#a29dff" "#a29dff" "blue"         ))
   (magenta    '("#ed3f7f" "#ed3f7f" "magenta"      ))
   (violet     '("#ed86ea" "#ed86ea" "brightmagenta"))
   (cyan       '("#aed9f6" "#aed9f6" "brightcyan"   ))
   (dark-cyan  '("#93c5e6" "#93c5e6" "cyan"         ))
   ...
   (selection      dark-blue)
   (builtin        orange)
   (comments       (if amora-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if amora-brighter-comments dark-cyan base5) 0.25))
   (constants      cyan)
   (functions      green)
   (keywords       magenta)
   (methods        teal)
   ...
   (level1 magenta)
   (level2 violet)
   (level3 (if amora-colorful-headers green   (doom-lighten violet 0.35)))
   (level4 (if amora-colorful-headers yellow  (doom-lighten magenta 0.35)))
   (level5 (if amora-colorful-headers cyan    (doom-lighten violet 0.6)))
   (level6 (if amora-colorful-headers orange  (doom-lighten magenta 0.6)))
   (level7 (if amora-colorful-headers blue    (doom-lighten violet 0.85)))
   (level8 (if amora-colorful-headers magenta (doom-lighten magenta 0.85)))
   (level9 (if amora-colorful-headers violet  (doom-lighten violet 0.95)))

   (-modeline-bright amora-brighter-modeline)
   (-modeline-pad
    (when amora-padded-modeline
      (if (integerp amora-padded-modeline) amora-padded-modeline 4)))
  ...
  (((line-number &override) :foreground base5)
   ...
   ((font-lock-comment-face &override)
    :background (if amora-comment-bg (doom-lighten bg 0.05)))
   (mode-line
